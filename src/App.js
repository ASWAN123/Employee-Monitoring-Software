       ...
       { !Loading && <contextData.Provider value={{ data , db , auth }}>
        ...
        { !(path === '/Employee-Monitoring-Software/qrgenerate' || path.includes('/Employee-Monitoring-Software/account') || path.includes('/Employee-Monitoring-Software/scanpage') ) && < Header auth={auth} /> }
          ...
          <Routes>
            ...
            <Route exact path="/Employee-Monitoring-Software/login" element={<Login  />}></Route>
            <Route exact path="/Employee-Monitoring-Software/register" element={<Register  />}></Route>
            <Route exact path="/Employee-Monitoring-Software/qrgenerate" element={ auth.currentUser ?  <Qrgenerate  /> : <Navigate to='/Employee-Monitoring-Software/'/> }></Route>
            <Route exact path="/Employee-Monitoring-Software/scanpage" element={<Scanpage />}></Route>
            <Route exact path="/Employee-Monitoring-Software/account" element={ auth.currentUser ? <Dashboard /> : <Navigate to="/Employee-Monitoring-Software/" /> }>
